from utils.functions import search_address_mapbox, is_in_bbox, subsetTif
from utils.variables import DATAS, BATI_3D
import rasterio
import pandas as pd
...
class Location:
    ...
    def create_plotly_map(self):
        ...
        '''
        gdb = fiona.open(BATI_3D, layer=0, driver='FileGDB')
